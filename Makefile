# This Makefile is for the Net::LineNotify extension to perl.
#
...
#     PREREQ_PM => { HTTP::Request::Common=>q[0], LWP::UserAgent=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Net/LineNotify.pm]
...
MAKE = make
FULLEXT = Net/LineNotify
BASEEXT = LineNotify
PARENT_NAME = Net
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Net/LineNotify.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/LineNotify.pm
...
TO_INST_PM = lib/Net/LineNotify.pm
...
manifypods : pure_all config  \
	lib/Net/LineNotify.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3SECTION) --perm_rw=$(PERM_RW) -u \
	  lib/Net/LineNotify.pm $(INST_MAN3DIR)/Net::LineNotify.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Net-LineNotify' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Net-LineNotify",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="darwin-thread-multi-2level-5.36" />' >> Net-LineNotify.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Net-LineNotify.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Net-LineNotify.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Net-LineNotify.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Net/LineNotify.pm' 'blib/lib/Net/LineNotify.pm' 
